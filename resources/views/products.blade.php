...
<html lang="en" class="no-js">
  <head>
    ...
    <style>
      ...
      .products-page .site-main-menu li.active-menu > a,
      .products-page .site-main-menu li.active-menu > a i {
        color: #ff724c;
      }
          ...
          'mainEntity' => [
              ...
              'itemListElement' => array_map(static function ($product, $index) {
                  return [
                      ...
                      'position' => $index + 1,
                      'name' => $product['title'],
                      'url' => str_starts_with($product['url'], 'http') ? $product['url'] : 'https://solarneutrino.com' . $product['url'],
                  ];
  ...
  <body class="products-page">
    ...
    <div id="page" class="page">
      <header id="site_header" class="header mobile-menu-hide header-color-light">
        ...
        <div class="site-nav">
          <ul id="nav" class="site-main-menu">
            <li><a href="/#home"><i class="menu-icon pe-7s-icon pe-7s-home"></i>Home</a></li>
            <li><a href="/#about_me"><i class="menu-icon pe-7s-icon pe-7s-user"></i>About me</a></li>
            <li><a href="/#resume"><i class="menu-icon pe-7s-icon pe-7s-id"></i>Resume</a></li>
            <li><a href="/#portfolio"><i class="menu-icon pe-7s-icon pe-7s-portfolio"></i>Portfolio</a></li>
            <li class="active-menu"><a href="/products"><i class="menu-icon pe-7s-icon pe-7s-box2"></i>Products</a></li>
            <li><a href="/#contact"><i class="menu-icon pe-7s-icon pe-7s-mail"></i>Contact</a></li>
          </ul>
        </div>
      </header>
      ...
      <div id="main" class="site-main">
        <div class="pt-wrapper" style="background-image: url(/images/Background_FullStack_Web_Developer_Laravel_PHP_JavaScript_AWS_MySQL_Roman_Primerov.svg);">
          <section class="pt-page pt-page-1 pt-page-current section-without-bg" data-id="products">
